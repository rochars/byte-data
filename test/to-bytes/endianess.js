...
describe('little endiand and big endian', function() {
    ...
    it('should turn 1 64-bit float to 8 bytes BE (pi)', function() {
        assert.deepEqual(byteData.floatTo8Bytes([3.141592653589793], 10, true),
