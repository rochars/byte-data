...
describe('unpack float16', function() {
    ...
    it('should turn 5 bytes hex to 2 16-bit float (65504)', function() {
        var halfs = byteData.unpackArray([255, 123], float16, 16);
...
describe('unpack int2', function() {   
    ...
    it('should turn 1 2-bit signed int to 2 crumb (0s)', function() {
        assert.deepEqual(
            byteData.unpackArray([2], int2, 2),
            [-2]);
    });
    it('should turn 1 2-bit signed int to 2 crumb (0s)', function() {
        assert.deepEqual(
            byteData.unpackArray([3], int2, 2),
            [-1]);
    });
    ...
    it('should turn 1 2-bit signed int to 1 crumb hex (-1)', function() {
        assert.deepEqual(
            byteData.unpackArray([3], int2, 16),
            [-1]);
    });
});
...
describe('unpack uInt2', function() {   
    ...
    it('should turn 1 2-bit unsigned int to 2 crumb (0s)', function() {
        assert.deepEqual(
            byteData.unpackArray([0], byteData.types.uInt2, 2),
            [0]);
    });
    it('should turn 1 2-bit unsigned int to 2 crumb (0s)', function() {
        assert.deepEqual(
            byteData.unpackArray([1], byteData.types.uInt2, 2),
            [1]);
    });
    it('should turn 1 2-bit unsigned int to 2 crumb (0s)', function() {
        assert.deepEqual(
            byteData.unpackArray([2], byteData.types.uInt2, 2),
            [2]);
    });
    it('should turn 1 2-bit unsigned int to 2 crumb (0s)', function() {
        assert.deepEqual(
            byteData.unpackArray([3], byteData.types.uInt2, 2),
            [3]);
    });
    it('should turn 1 2-bit signed int to 2 crumb (0s)', function() {
        assert.deepEqual(
    ...
    it('should turn 1 2-bit unsigned int to 1 crumb hex (2)', function() {
        assert.deepEqual(
            byteData.unpackArray([2], byteData.types.uInt2, 16),
            [2]);
    });
    it('should turn 1 2-bit unsigned int to 1 crumb bin (1)', function() {
        assert.deepEqual(
            byteData.unpackArray([1], byteData.types.uInt2, 16),
            [1]);
    });
});
